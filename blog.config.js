...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://polydactyl-sailboat-cbd.notion.site/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID ||
    '7c1d570661754c8fbc568e00a01fd70e',
  ...
  GREETING_WORDS:
    ...
    'Welcome to GoldenBuds! Goldenbuds is a LED grow lights and electronics manufacturer.',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'GoldenBuds', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Your tailored LED grow lights and electronics manufacturer.', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.goldenbuds.online', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'GoldenBuds, LED Grow Lights, notion，blog，github, indoor planting, vertical farming, indoor farming, weed, cannabis, marijuanna, hydroponics, grow panel lights, grow light bar, grow light bulb, grow spotlight, electronics, earphone, mobile, greenhouse, full spectrum, earbuds', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'goldenbuds@goldenbuds.online', // 邮箱地址 例如mail@tangly1024.com
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://image.msvr.dpdns.org/file/251f17e464215df1833cf.png',  // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png, https://image.msvr.us.kg/file/251f17e464215df1833cf.png, https://raw.githubusercontent.com/leaflyingl/picx-images-hosting/master/10311130.png
  ...
  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || 'nipfibowjp', // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
  ...
  // 谷歌广告
  ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'ca-pub-5015431604105277', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
