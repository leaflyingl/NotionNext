...
const BLOG = {
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'GoldenBuds, LED Grow Lights, notion，blog，github, indoor planting, vertical farming, indoor farming, hydroponics, grow panel lights, grow light bar, grow light bulb, grow spotlight, electronics, earphone, greenhouse, full spectrum, earbuds', // 网站关键词 英文逗号隔开
